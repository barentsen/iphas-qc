...
def quality_flag(fieldid, seeing, ellipt, r5sig, i5sig, h5sig, rmode, f10p, f20p, n10p, n20p):
    ...
    if (seeing <= 1.25) \
    and (fieldid in whitelist or np.isnan(f10p) or (f10p < 0.68) or n10p < 10) \
    and (fieldid in whitelist or np.isnan(f20p) or (f20p < 0.05) or n20p < 5):
      return "A++"

    if (seeing <= 1.5) \
    and (fieldid in whitelist or np.isnan(f10p) or (f10p < 1.63) or n10p < 10) \
    and (fieldid in whitelist or np.isnan(f20p) or (f20p < 0.14) or n20p < 5):
        return "A+"

    if (seeing <= 2.0) \
    and (fieldid in whitelist or np.isnan(f10p) or (f10p < 5.02) or n10p < 10) \
    and (fieldid in whitelist or np.isnan(f20p) or (f20p < 0.31) or n20p < 5):
        return "A"

    if (seeing <= 2.5) \
    and (fieldid in whitelist or np.isnan(f10p) or (f10p < 5.02) or n10p < 20) \
    and (fieldid in whitelist or np.isnan(f20p) or (f20p < 0.31) or n20p < 10):
        return "B"

    if (seeing <= 2.5) \
    and (fieldid in whitelist or np.isnan(f10p) or (f10p < 11.3) or n10p < 20) \
    and (fieldid in whitelist or np.isnan(f20p) or (f20p < 0.65) or n20p < 10):
        return "C"
